 ...
 * 
 * Returns active and inactive therapist counts
...
export async function GET() {
  try {
    ...
    if (activeError) {
      ...
      return NextResponse.json(
        { error: 'Failed to fetch therapist activity statistics' },
        { status: 500 }
      );
    }
    ...
    console.error('Error in GET /api/statistics/therapists/activity:', error);
    return NextResponse.json(
